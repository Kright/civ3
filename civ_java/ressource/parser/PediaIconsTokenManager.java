/* Generated By:JavaCC: Do not edit this line. PediaIconsTokenManager.java */
...
public class PediaIconsTokenManager implements PediaIconsConstants
{
...
public PediaIconsTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public PediaIconsTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
